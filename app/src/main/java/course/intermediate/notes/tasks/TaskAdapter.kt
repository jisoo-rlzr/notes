...
class TaskAdapter(
    ...
    inner class TaskViewHolder(view: View) : BaseViewHolder<Task>(view) {
        ...
        override fun onBind(data: Task, index: Int) {
            (view as TaskView).initView(data) { todoIndex, isChecked ->
                dataActionDelegate.onTodoUpdated(index, todoIndex, isChecked)
            }
        }
    ...
    inner class AddButtonViewHolder(view: View) : BaseRecyclerAdapter.AddButtonViewHolder(view) {
        ...
        override fun onBind(data: Unit, index: Int) {
            ...
            view.setOnClickListener {
                touchActionDelegate.onAddButtonClicked(NavigationActivity.FRAGMENT_TYPE_TASK)
            }
        }
